/**
 * Test Data Generator — Random Protocol Graphs
 *
 * Generates synthetic protocol rules for performance testing
 * and chaos/robustness testing.
 */
 ...
 */
export function generateRandomProtocol(numStates: number): GeneratedProtocol {
...
export const authProtocolRules = new Map<string, StateAnnotation>([
...
export const fileProtocolRules = new Map<string, StateAnnotation>([
...
export const dbProtocolRules = new Map<string, StateAnnotation>([
...
export function mergeProtocolRules(...maps: Map<string, StateAnnotation>[]): Map<string, StateAnnotation> {
  const merged = new Map<string, StateAnnotation>();
  for (const m of maps) {
