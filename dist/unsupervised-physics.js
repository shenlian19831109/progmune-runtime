...
exports.CROSS_REPO_SEQUENCES = void 0;
exports.fingerprint = fingerprint;
exports.fingerprintSequences = fingerprintSequences;
exports.clusterByStructure = clusterByStructure;
exports.evaluateUnsupervisedDiscovery = evaluateUnsupervisedDiscovery;
exports.runUnsupervisedDiscovery = runUnsupervisedDiscovery;
exports.printUnsupervisedReport = printUnsupervisedReport;
/**
 * Extract structural fingerprint from a function in context.
 * Uses ONLY positional and structural features — NO function names.
 */
function fingerprint(fn, index, sequence) {
 ...
 */
function fingerprintSequences(sequences) {
    const fps = new Map();
 ...
 */
function clusterByStructure(sequences) {
 ...
 */
function evaluateUnsupervisedDiscovery(sequences) {
 ...
 */
function runUnsupervisedDiscovery() {
    const perRepo = {};
    const allSeqs = [];
    for (const [repo, seqs] of Object.entries(exports.CROSS_REPO_SEQUENCES)) {
...
function printUnsupervisedReport(report) {
    console.log("\n╔════════════════════════════════════════════════════╗");
