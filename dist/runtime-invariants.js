...
function assertLedgerConsistency(ledger, namespaceInitialStates = new Map([["_global", "INIT"]])) {
    if (ledger.length === 0)
        return;
...
function assertLedgerInvariants(ledger, namespaceInitialStates = new Map([["_global", "INIT"]]), expectedRuleHash) {
