...
const accountability_1 = require("../ledger/accountability");
...
let acct;
try {
    acct = (0, accountability_1.buildAccountabilityChain)(cert.sessionId, {
        author,
...
const result = (0, engine_1.evaluatePolicy)(ctx, rules);
if (useJson) {
...
// ── Formatter ──
function formatPolicyResult(result, file, policySource) {
    const lines = [];
