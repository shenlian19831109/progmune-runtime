...
async function main() {
    ...
    let data = { repo: repoPath, labeledAt: "", total: 0, labels: {}, sequences: {} };
    ...
    rl.close();
    saveLabels(labelFile, data, labeled + alreadyLabeled);
    console.error(`\n  Clean: ${Object.values(data.labels).filter((l) => l === "clean").length}`);
...
function saveLabels(filePath, data, total) {
