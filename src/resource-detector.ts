...
function isCleanupFunction(funcName: string): boolean {
...
export function detectResourceViolations(calls: string[], enclosingFuncName?: string): ResourceViolation[] {
 ...
 */
export function validateResourceLifecycle(calls: string[], enclosingFuncName?: string): {
  valid: boolean;
