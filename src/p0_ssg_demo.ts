...
const authProtocol: FunctionProtocol[] = [
  {
...
function runDemo() {
  ...
  const validator1 = new StateMachineValidator(authProtocol, 'UNAUTHENTICATED');
  let allPassed = true;
  ...
  const validator2 = new StateMachineValidator(authProtocol, 'UNAUTHENTICATED');
